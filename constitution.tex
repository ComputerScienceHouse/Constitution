...
Executive Members have the authority to manage user accounts for House systems.
...
\end{enumerate}
Accounts for honorary and advisory members may be created at the discretion of Executive Board.
...
\begin{enumerate}
	\item A Active Member drafts a change to the Code of Conduct and makes publicly available both the summary and difference file of the change.
