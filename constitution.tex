...
\asubsection{Responsibilities of Committees}
\begin{enumerate}
	\item Committees are responsible for the task for which they were created
	\item Any responsibilities of the Committee are placed upon the assigned Lead
\end{enumerate}
...
\asubsection{Qualifications to be the House Secretary, an Ad Hoc Director, or a Committee Lead}
\begin{enumerate}
...
\asubsection{Selection of Committee Leads}
\begin{enumerate}
	\item When a group of House members feels a Committee is necessary, a public declaration may be made during House Meeting, stating the purpose of the Committee.
	\item When a Committee is declared it is automatically granted status and a Lead is appointed, but all other aspects of a Committee's operation are at the Lead's discretion.
	\item When a Committee is granted status it is never granted a budget.
\end{enumerate}
...
\item When the task of a Committee has been completed, the Committee dissolves.
	A Committee may be dissolved at any time by a simple majority vote of the Executive Board.
\end{enumerate}
