...
\begin{tabular}{ l  l  l l l l}
	...
	CSH     & \textit{Computer Science House} & OpChomm        & \textit{Operational Communications}   \\
...
\begin{enumerate}
	\item A candidate for the OpChomm Directorship shall be chosen by the current RTPs.
...
The OpChomm Directorship is responsible for overseeing the implementation of maintenance and upgrades to the CSH computer systems networks.
