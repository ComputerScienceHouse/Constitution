...
\end{itemize}
At the discretion of the Evaluations Director, any Introductory Packet may be extended to accommodate extenuating circumstances. Additionally, at the discretion of the Evaluations director or the Executive Board, any member can be removed from the list of required signatures if the member is not actively engaging with Introductory Members. The removed member must then be alerted by the Evaluations director and informed of how they can again become a required signature. This decision can be overwritten by the Executive Board through a simple majority vote of the voting members of the Executive Board.
