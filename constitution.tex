...
\begin{enumerate}
  \item The following requirements may be waived as decided by a Two-Thirds Immediate Vote as described in \ref{Two-Thirds} and \ref{Immediate Vote}:
    ...
    \end{enumerate}
  \item This process operates for one requirement at a time
  \item This process operates for one voting executive board position or the Chairperson at a time
  \item This process operates on the current election only
  \item Any requirements waived using this process are waived for all candidates for the given position for the current election process
\end{enumerate}
