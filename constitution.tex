...
Inorder to be counted in quorum for, and to vote in, an Introductory Evaluation, each Active Member must complete the requirements outlined in \ref{Expectations of Voting Members} within the current Operating Session, prior to the beginning of the evaluation.
...
Any of the folowing requirements may be waived by the Evaluations Director or a simple majority vote by the Executive Board
\begin{itemize}
\item Attend all House meetings during the process
\item Attend at least one House directorship meeting for each week of the process (including permanent and Ad Hoc directorship meetings)
\item Attend at least one House social event during the process
