...
Maintainers must have Active or Alumni in good standing status.
...
\end{itemize}
Failure to adequately meet any of these expectations is grounds for revocation of maintainer status.

\asubsection{Maintainer Resignations}
Maintainers may resign at any time by notifying the current eboard and maintainer group.

\asubsection{Maintainer Term}
Maintainer status lasts until it is resigned, or revoked by Executive Board vote.
