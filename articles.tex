...
Any modifications to the written proposal must be posted in the House during the week following the proposal.
The final proposal is presented one week following the proposal's initial introduction at House Meeting for discussion.
Ballots are distributed for a ballot House vote as described in \ref{Balloted Vote}.
...
The winning option is selected outright if it gains more than half the votes as a first preference.
...
This process continues until one option has half of the votes and is elected.
