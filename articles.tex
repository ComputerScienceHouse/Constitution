...
Each of these amendments is given a designated period of time, and will cease to exist immedietely. 
...
Occasionaly, Temporary Amendments may become permanent through a referendum, which is described in detail as part of each Temporary Amendment. 
...
Additionally, \ref{Introductory Executive Board} will also no longer be elected or perform any duties during the described period. 
...
During the described period, the percentage of required signatures in the Introductory Packet is increased to 75\%. 
\asubsubsection{Changes to Packet Distribution}
Introductory Members will recieve an \ref{The Introductory Packet} at the begining of the second week of each semester. 
Any applicants who wish to become Introductory Members after the third week of each semester will recieve their packet during the begining of the second week of the following semester. 
During the first, second, or third week of each semester, any applicant may have their application evaluated during a standard Evaluations Directorship Meeting or during either House Meeting or an Executive Board Meeting. 
\asubsubsection{PR Director} 
Public Relations Director is added to \ref{Voting Members}, and is given the following responsibilities during the described period.  
\begin{enumerate}
	\item To preside over Public Relations Directorship Meetings.
	\item To exercise general supervision over the Public Relations operations.
	\item To communicate clearly with the Rochester Institute of Technology's extended community.
...
\end{enumerate}
\asubsubsection{Evaluations and Social Directorship Changes}
The Evalutations Director and Social Director(s) will have the following additional responsibilities during the described period. 
\begin{enumerate}
	\item To preside over a number of events intended to produce interest in CSH, especially in RIT students during the begining weeks of each semester.
\end{enumerate}
\asubsubsection{Evaluation Period}
During the described period, the \ref{The Introductory Process} will begin during the first week of each semester or when the Evaluations Director otherwise chooses to initiates it.
