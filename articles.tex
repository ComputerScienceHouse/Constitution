...
\externaldocument{bylaws}[https://github.com/bencentra/Constitution/blob/master/bylaws.pdf?raw=true]
...
An Active Member may resign by submitting in writing the reason for resignation to the Chairman, or Evaluations Director.  The resignation will take effect immediately.
...
\begin{enumerate}
	...
	\item The winners are determined by a simple majority vote of the ballots cast as defined in \ref{Simple Majority}, Voting. A quorum of fifty-percent of the Total Number of Possible Votes is required for the elections to be official. All winners are notified of their election, and they immediately assume the office for the term of the election. Any office whose winner declines the election, or whose winner was a write-in candidate who does not fulfill the requirements of the elected office, shall remain vacant and a new election process shall begin for that office.
\end{enumerate}
...
Decisions made by the Executive Board may be appealed and overturned. To initiate an appeal, a Petition of Appeal must be presented to the Chairman affixed with signatures either one third of Active Members or three voting members of the Executive Board. After the petition is presented, the decision is overturned and will be reevaluated by the Executive Board at the upcoming Executive Board meeting.
