...
\begin{itemize}
	\item Forfeit their right to vote
	\item Do not count towards quorum
...
A leave of absence request must include the following information about the member: name, email, phone number, start date, expected return date, and a reason for the leave. The request is then given to a staff member of Residence Life, excluding student employees, for approval.
...
A member may return from a leave of absence whenever they choose to. When a member wishes to return, they must in writting notify the Evaluations Director to end their leave.
