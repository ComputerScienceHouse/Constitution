...
\begin{enumerate}
	...
	\item Successfully complete Introductory Evaluations or obtain greater than or equal to 60\% (rounded up to the nearest whole person) of each of the following types of signatures in the Introductory Packet:
		\begin{itemize}
			\item All Resident Active members and Executive Board members
			\item All Introductory members residing on floor
			\item Fifteen (15) Non-Resident and/or Alumni members (not including Non-Resident Executive Board members)
		\end{itemize}
\end{enumerate}
