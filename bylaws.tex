...
An Introductory Executive Board is elected by the introductory members to lead and manage the project as well as represent the introductory project participants to House.
...
\bsubsubsection{Introductory Project Evaluations Process}
The Evaluations Director determines whether each introductory member passes or fails the Introductory Project by using information gathered from the Introductory Project Executive Board and the Introductory Project Advisors.
The Evaluations Director then reports the status of each Introductory Member's Introductory Project Evaluation to said Introductory Member.
