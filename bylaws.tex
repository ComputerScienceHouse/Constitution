...
\begin{enumerate}
	...
	\item If the applicant has passed an Introductory Evaluation in the past an optional Simple Majority vote may be held to allow the applicant to automatically pass the Introductory Evaluation. Any member in attendance may motion for this vote to occur.
\end{enumerate}
